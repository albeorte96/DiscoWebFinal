...
<div id="container">
<div id="header">
<h1>MI DISCO EN LA NUBE version 1.0</h1>
</div>
<div id="content">
<?= $contenido ?>
</div>
...
function inicializarEventos() {
	  ...
	  $(".descarga").click(presionDescarga);
	  $(".descarga").mouseover(CambiaColorModificar);
	  $(".descarga").mouseout(CambiaColorNormal);
	  $(".renombrar").mouseover(CambiaColorDetalles);
	  $(".renombrar").mouseout(CambiaColorNormal);
}
...
function presionDescarga() {
	  alert("Usted va a descargar el fichero");
}
