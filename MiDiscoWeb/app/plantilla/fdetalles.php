    ...
    for ($j = 0; $j < count($datosusuario); $j ++) {
        switch ($j) {
            ...
            case 4:
                ...
                if ($datosusuario[2]==PLANES[0]){echo "<p>Espacio ocupado: ", $datosusuario[$j]/1000, "/2000 KB (".round(((($datosusuario[$j]/1000)/2000)*100),2,null)."%)</p>";}
                if ($datosusuario[2]==PLANES[1]){echo "<p>Espacio ocupado: ", $datosusuario[$j]/1000, "/5000 KB (".round(((($datosusuario[$j]/1000)/5000)*100),2,null)."%)</p>";}
                if ($datosusuario[2]==PLANES[2]){echo "<p>Espacio ocupado: ", $datosusuario[$j]/1000, "/10000 KB (".round(((($datosusuario[$j]/1000)/10000)*100),2,null)."%)</p>";}
                break;
